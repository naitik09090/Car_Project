...
<body class="bg-black text-white">
    ...
    <nav
        ...
        <div
            ...
            <div class="d-flex align-items-center gap-4">
                <a href="index.php" class="nav-hover text-white text-decoration-none position-relative">
                    <span><?= "Home" ?></span>
                    <span><?= "Home" ?></span>
                </a>

                <a href="Store_Data.php" class="nav-hover text-white text-decoration-none position-relative">
                    <span><?= "Store" ?></span>
                    <span><?= "Store" ?></span>
                </a>

                <a href="Car_Price.php" class="nav-hover text-white text-decoration-none position-relative">
                    <span><?= "Pricing" ?></span>
                    <span><?= "Pricing" ?></span>
                </a>
            </div>
    ...
    <div id="mobileMenu"
        ...
        <a href="Store_Data.php" class="text-white text-decoration-none">Store</a>
        <a href="Car_Price.php" class="text-white text-decoration-none">Pricing</a>
        <?php if (!isset($_SESSION['user'])): ?>
            <a href="Contect_Us.php">
                <button class="btn btn-outline-light rounded-pill px-4 py-2">Contact Us</button>
            </a>
